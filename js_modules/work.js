...
let ok_ops_count = 0;
    ...
    if (isJson.approve === true && opbody.to === 'null' && opbody.amount.indexOf('GBG') > -1 && parseFloat(opbody.amount) >= parseFloat(conf.vote_price) && isJson.data && isJson.data.contractName === 'golos-votes') {
        let arr = isJson.data;
